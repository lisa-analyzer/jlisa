...
public class ReflectionTest extends JLiSAAnalysisExecutor {
	...
	public void testClassForName2() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-for-name-2", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testClassNewInstance1() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-new-instance-1", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testClassNewInstance2() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-new-instance-2", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testGetField2() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-get-field-2", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testFieldGetSet1() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "field-get-set-1", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testClassGetMethod1() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-get-method-1", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testClassGetMethod2() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "class-get-method-2", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
	...
	public void testMethodInvoke2() throws IOException {
		CronConfiguration conf = TestHelpers.assertCheckerWithConstantPropagation("reflection", "method-invoke-2", "Main.java");
		conf.outputs.add(new HtmlResults(true));
		perform(conf);
	}
