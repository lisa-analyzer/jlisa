 ...
 */
public class RecencyAbsFieldSensitivePointBasedHeap
		extends
		AllocationSiteBasedAnalysis<RecencyAbstractionHeapEnvWithFields> {

	private final Rewriter rewriter = new Rewriter();

	@Override
	public RecencyAbstractionHeapEnvWithFields makeLattice() {
		return new RecencyAbstractionHeapEnvWithFields();
	}

	@Override
	public RecencyAbstractionHeapEnvWithFields shallowCopy(
		...
		StackAllocationSite clone = new StackAllocationSite(
				...
				site.isWeak(),
				id.getCodeLocation());
		RecencyAbstractionHeapEnvWithFields heap = store(state, id, clone);
	...
	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> smallStepSemantics(
			RecencyAbstractionHeapEnvWithFields state,
		...
		if (expression instanceof AccessChild) {
			...
			if (!alreadyAllocated.isEmpty()) {
				...
				if (!replacements.isEmpty()) {
					...
					st = new RecencyAbstractionHeapEnvWithFields(st.lattice, map, st.fields);
				}
	 ...
	 * {@link RecencyAbsFieldSensitivePointBasedHeap} domain.
	 * 
	 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
	 */
	public class Rewriter
			extends
			AllocationSiteBasedAnalysis<RecencyAbstractionHeapEnvWithFields>.Rewriter {
