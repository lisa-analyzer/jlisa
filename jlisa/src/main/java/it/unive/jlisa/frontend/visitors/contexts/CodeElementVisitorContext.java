...
public class CodeElementVisitorContext extends VisitorContext {
    ...
    public CodeElementVisitorContext(ParserContext parserContext, String source, CompilationUnit compilationUnit,
                                     BaseUnitASTVisitor container, CFG cfg,
                                     JavaLocalVariableTracker tracker, ControlFlowTracker control) {
