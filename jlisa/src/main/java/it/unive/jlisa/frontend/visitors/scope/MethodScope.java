...
public final class MethodScope extends Scope implements EnclosableScope<ClassScope> {
    ...
    public MethodScope(ClassScope parentScope, CFG cfg, JavaLocalVariableTracker tracker, ControlFlowTracker controlFlowTracker) {
    ...
    @Override
    public ClassScope getParentScope() { return this.parentScope; }
    ...
    public void setSwitchItem(Expression switchItem) {
