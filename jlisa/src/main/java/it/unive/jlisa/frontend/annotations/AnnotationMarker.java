...
public class AnnotationMarker extends Statement {
    ...
    public AnnotationMarker(CFG cfg, CodeLocation location, AnnotationInfo info) {
        super(cfg, location);
        this.info = info;
    }
    ...
    AnalysisState<A> forwardSemantics(AnalysisState<A> entryState,
                                      InterproceduralAnalysis<A, D> interproc,
                                      StatementStore<A> store) throws SemanticException {
        return entryState;
    }
