...
/**
 * Central context for parsing operations that manages program state, variable types,
 * location managers, and exception handling during the front-end parsing process.
 * This class serves as a coordination point for various parsing activities and
 * maintains the necessary state information for code analysis.
 *
 * <p>The parser context provides:</p>
 * <ul>
...
public class ParserContext {
    ...
    /**
     * Adds a variable type mapping for a specific CFG. This method tracks the static
     * type of variables within the scope of a particular control flow graph.
     *
    ...
    /**
     * Retrieves the static type of a variable by searching through the CFG's local variables,
     * global variables in the containing unit and its ancestors, and finally checking if
     * the name corresponds to a compilation unit.
     *
     ...
     * file position. This manager is used for tracking real source code locations.
     *
    ...
    /**
     * Retrieves or creates a SyntheticCodeLocationManager for the specified file.
     * This manager is used for tracking synthetic (compiler-generated) code locations.
     * The same manager instance is returned for subsequent calls with the same fileName.
     * Using the manager provided by the parser ensures that the dispatched synthetic location is free.
     * @param fileName the name of the file to associate with synthetic locations
