...
public final class AnnotationBuilder {
    ...
    public static Annotations fromDeclarationModifiers(List<?> modifiers) {
    ...
    public static Annotation fromJdt(org.eclipse.jdt.core.dom.Annotation jdtAnn) {
    ...
    private static AnnotationValue parseAnnotationValue(Expression expr) {
        return switch (expr) {
     ...
     */
    private static BasicAnnotationValue getNumericAnnotationValue(NumberLiteral literal) {
    ...
    private static ArrayAnnotationValue getArrayAnnotationValue(ArrayInitializer arrayInitializer) {
