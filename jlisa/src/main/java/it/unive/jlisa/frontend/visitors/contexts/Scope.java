...
public final class Scope {
	...
	public Scope withEnclosingClass(
			JavaClassType type) {
		return new Scope(lisaUnit, type, container);
	}

	public it.unive.lisa.program.CompilationUnit lisaUnit() {
		return lisaUnit;
	}

	public JavaClassType enclosingClass() {
		return enclosingClass;
	}

	public BaseUnitASTVisitor container() {
		return container;
	}
}