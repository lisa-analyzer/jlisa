...
import it.unive.jlisa.program.operator.JavaLongToStringUnaryOperator;
...
public class LongToStringUnary extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public LongToStringUnary(
			CFG cfg,
	...
	public static LongToStringUnary build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongToStringUnary(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		it.unive.lisa.symbolic.value.UnaryExpression toString = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType,
				accessExpr,
				JavaLongToStringUnaryOperator.INSTANCE,
				getLocation());
