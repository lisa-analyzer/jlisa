...
public class StringCharArrayFromToConstructor extends BinaryExpression implements PluggableStatement {
	...
	public static StringCharArrayFromToConstructor build(
			...
			CodeLocation location,
			Expression... params) {
		return new StringCharArrayFromToConstructor(cfg, location, params[0], params[1]);
	}
