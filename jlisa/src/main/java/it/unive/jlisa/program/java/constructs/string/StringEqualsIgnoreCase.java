...
public class StringEqualsIgnoreCase extends BinaryExpression implements PluggableStatement {
	...
	public static StringEqualsIgnoreCase build(
			...
			Expression... params) {
		return new StringEqualsIgnoreCase(cfg, location, params[0], params[1]);
	}
