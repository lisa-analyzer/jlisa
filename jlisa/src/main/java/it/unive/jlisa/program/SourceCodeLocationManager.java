...
/**
 * Manages source code locations within a file, allowing navigation through
 * line and column positions. This class is used by the front-end to determine
 * which locations a statement should use during code analysis or compilation.
 *
 * <p>The manager maintains a current position that can be advanced line by line
 * or column by column, and provides methods to retrieve location information
 * at any position within the source file.</p>
 *
 */
...
public class SourceCodeLocationManager {
    ...
    /**
     * Constructs a new SourceCodeLocationManager starting at the specified position.
     *
     * @param sourceFile the path or name of the source file to manage
    ...
    /**
     * Advances to the next line and resets the column to 0.
     * Updates the current location to reflect the new position.
     *
     * @return the new current SourceCodeLocation after advancing to the next row
     */
    ...
    /**
     * Advances to the next column on the current line.
     * Updates the current location to reflect the new position.
     *
     * @return the new current SourceCodeLocation after advancing to the next column
     */
