package it.unive.jlisa.program.java.constructs.outputstream;
...
public class OutputStreamConstructor extends NaryExpression implements PluggableStatement {
	...
	public static OutputStreamConstructor build(
			...
			CodeLocation location,
			Expression... params) {
		return new OutputStreamConstructor(cfg, location);
	}
