...
public class LongValue extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public LongValue(CFG cfg, CodeLocation location, Expression expr) {
		super(cfg, location, "doubleValue", expr);
	}

	public static LongValue build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongValue(cfg, location, params[0]);
	}
