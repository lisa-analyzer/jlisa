...
public class SynchronizedBlock extends ControlFlowStructure {
	...
	public SynchronizedBlock(NodeList<CFG, Statement, Edge> cfgMatrix, Statement syncTarget, Statement nullnessCondition, 
			Collection<Statement> body,	Statement firstFollower) {
