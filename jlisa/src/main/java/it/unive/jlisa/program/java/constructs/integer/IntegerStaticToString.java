...
import it.unive.jlisa.program.operator.JavaIntStaticToStringOperator;
...
public class IntegerStaticToString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public IntegerStaticToString(
			CFG cfg,
	...
	public static IntegerStaticToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new IntegerStaticToString(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression lower = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType, access, JavaIntStaticToStringOperator.INSTANCE, getLocation());
