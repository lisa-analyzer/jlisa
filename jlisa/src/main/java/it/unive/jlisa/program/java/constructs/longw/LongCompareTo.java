...
import it.unive.jlisa.program.operator.JavaLongCompareToOperator;
...
public class LongCompareTo extends BinaryExpression implements PluggableStatement {
	protected Statement originating;

	protected LongCompareTo(
			CFG cfg,
	...
	public static LongCompareTo build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongCompareTo(cfg, location, params[0], params[1]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdBinarySemantics(
		...
		it.unive.lisa.symbolic.value.BinaryExpression rotate = new it.unive.lisa.symbolic.value.BinaryExpression(
				...
				accessLeft,
				accessRight,
				JavaLongCompareToOperator.INSTANCE,
				getLocation());
