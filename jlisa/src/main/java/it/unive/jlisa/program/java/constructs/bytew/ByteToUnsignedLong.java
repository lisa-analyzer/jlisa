...
public class ByteToUnsignedLong extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public ByteToUnsignedLong(
			CFG cfg,
			CodeLocation location,
			Expression expr) {
		super(cfg, location, "toUnsignedInt", expr);
	}

	public static ByteToUnsignedLong build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new ByteToUnsignedLong(cfg, location, params[0]);
	}
