...
public class FloatValueOf extends it.unive.lisa.program.cfg.statement.UnaryExpression implements PluggableStatement {
	...
	public static FloatValueOf build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FloatValueOf(cfg, location, params[0]);
	}
