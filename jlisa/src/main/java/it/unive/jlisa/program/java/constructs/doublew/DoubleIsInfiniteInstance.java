...
public class DoubleIsInfiniteInstance extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public DoubleIsInfiniteInstance(
			CFG cfg,
	...
	public static DoubleIsInfiniteInstance build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new DoubleIsInfiniteInstance(cfg, location, params[0]);
	}
