 ...
 * that are not actually present in the original source code. This class
 * provides a way to assign unique locations to compiler-generated or
 * transformed statements without interfering with real source code locations.
 * <p>
 * Synthetic locations use an offset-based system rather than line/column
 * coordinates, ensuring they remain distinct from actual source positions. This
 * is particularly useful for intermediate representations, compiler
...
public class SyntheticCodeLocationManager {
	...
	/**
	 * Constructs a new SyntheticCodeLocationManager starting at offset 0. Both
	 * the current and root locations are initialized to the same starting
	 * position.
	 *
	 * @param sourceFile the path or name of the source file to associate with
	 *                       synthetic locations
	 */
	public SyntheticCodeLocationManager(
			String sourceFile) {
	...
	/**
	 * Returns the current synthetic location managed by this instance. This
	 * location reflects the most recent position after any advancement
	 * operations.
	 *
	 ...
	 * <p>
	 * This method should be called when generating a new synthetic statement
	 * that requires a unique location identifier.
	 * </p>
	 *
	 ...
	 */
	public SyntheticCodeLocation getLocation(
			int offset) {
