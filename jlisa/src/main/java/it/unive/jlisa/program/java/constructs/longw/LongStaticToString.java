...
import it.unive.jlisa.program.operator.JavaLongStaticToStringOperator;
...
public class LongStaticToString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public LongStaticToString(
			CFG cfg,
	...
	public static LongStaticToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongStaticToString(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression lower = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType, access, JavaLongStaticToStringOperator.INSTANCE, getLocation());
