...
public class ShortValueOf extends it.unive.lisa.program.cfg.statement.UnaryExpression implements PluggableStatement {
	...
	public static ShortValueOf build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new ShortValueOf(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		Type doubleType = JavaClassType.lookup("java.lang.Short");
