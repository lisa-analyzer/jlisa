...
import it.unive.jlisa.program.operator.JavaIntToHexStringOperator;
...
public class IntegerToHexString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public IntegerToHexString(
			CFG cfg,
	...
	public static IntegerToHexString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new IntegerToHexString(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression lower = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType, access, JavaIntToHexStringOperator.INSTANCE, getLocation());
