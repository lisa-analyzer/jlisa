...
public class StringToLowerCase extends UnaryExpression implements PluggableStatement {
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		it.unive.lisa.symbolic.value.UnaryExpression lower = new it.unive.lisa.symbolic.value.UnaryExpression(stringType, accessExpr, JavaStringToLowerCaseOperator.INSTANCE, getLocation());
