...
import it.unive.jlisa.program.operator.JavaShortStaticToStringOperator;
...
public class ShortStaticToString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public ShortStaticToString(
			CFG cfg,
	...
	public static ShortStaticToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new ShortStaticToString(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression un = new it.unive.lisa.symbolic.value.UnaryExpression(
				...
				expr,
				JavaShortStaticToStringOperator.INSTANCE,
				getLocation());
