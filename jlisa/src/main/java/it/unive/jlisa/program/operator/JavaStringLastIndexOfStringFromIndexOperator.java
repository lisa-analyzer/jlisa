...
public class JavaStringLastIndexOfStringFromIndexOperator implements StringOperator,TernaryOperator{
	 ...
	 */
	public static final JavaStringLastIndexOfStringFromIndexOperator INSTANCE = new JavaStringLastIndexOfStringFromIndexOperator();
	 ...
	 */
	protected JavaStringLastIndexOfStringFromIndexOperator() {
	}
