...
public class ByteToUnsignedInt extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public ByteToUnsignedInt(
			CFG cfg,
			CodeLocation location,
			Expression expr) {
		super(cfg, location, "toUnsignedLong", expr);
	}

	public static ByteToUnsignedInt build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new ByteToUnsignedInt(cfg, location, params[0]);
	}
