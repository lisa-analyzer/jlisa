...
public class FloatIsNaN extends UnaryExpression implements PluggableStatement {
	...
	public static FloatIsNaN build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FloatIsNaN(cfg, location, params[0]);
	}
