...
public class FloatIsInfiniteInstance extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public FloatIsInfiniteInstance(
			CFG cfg,
	...
	public static FloatIsInfiniteInstance build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FloatIsInfiniteInstance(cfg, location, params[0]);
	}
