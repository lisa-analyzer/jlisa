...
import it.unive.jlisa.program.operator.JavaLongToStringOperator;
...
public class LongToString extends BinaryExpression implements PluggableStatement {
	...
	public static LongToString build(
			...
			CodeLocation location,
			Expression... params) {
		return new LongToString(cfg, location, params[0], params[1]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdBinarySemantics(
		...
		it.unive.lisa.symbolic.value.BinaryExpression toString = new it.unive.lisa.symbolic.value.BinaryExpression(
				...
				accessLeft,
				accessRight,
				JavaLongToStringOperator.INSTANCE,
				getLocation());
