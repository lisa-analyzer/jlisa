...
public class LongValueOf extends UnaryExpression implements PluggableStatement {
	...
	public LongValueOf(CFG cfg, CodeLocation location, Expression exp) {
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		ReferenceType reftype = (ReferenceType) new ReferenceType(longType);
		...
		// allocate the string
		JavaNewObj call = new JavaNewObj(getCFG(), (SourceCodeLocation) getLocation(), "String", new JavaReferenceType(longType), new Expression[0]);
