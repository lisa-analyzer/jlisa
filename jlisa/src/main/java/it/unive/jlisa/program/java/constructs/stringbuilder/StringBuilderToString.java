...
public class StringBuilderToString extends UnaryExpression implements PluggableStatement {
	...
	public static StringBuilderToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringBuilderToString(cfg, location, params[0]);
	}
