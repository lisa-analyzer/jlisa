...
public class JavaStringReplaceFirstOperator implements StringOperator, TernaryOperator {

	/**
	 * The singleton instance of this class.
	 */
	public static final JavaStringReplaceFirstOperator INSTANCE = new JavaStringReplaceFirstOperator();
	 ...
	 */
	protected JavaStringReplaceFirstOperator() {
	}
