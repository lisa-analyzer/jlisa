...
public interface NaryOperator extends Operator {
	 ...
	 *                   program
	 * @param first   the set of types of the first argument of this
	 *                   expression
	 * @param second the set of types of the second argument of this expression
	 * @param third  the set of types of the third argument of this
	 *                   expression
	 * @param fourth the set of types of the fourth argument of this
	 * 					 expression
	 * 
