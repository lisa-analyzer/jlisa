...
public class FloatIsFinite extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public FloatIsFinite(
			CFG cfg,
	...
	public static FloatIsFinite build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FloatIsFinite(cfg, location, params[0]);
	}
