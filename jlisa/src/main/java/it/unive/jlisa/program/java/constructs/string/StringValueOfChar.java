...
public class StringValueOfChar extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public StringValueOfChar(CFG cfg, CodeLocation location, Expression exp) {
		super(cfg, location, "valueOf", exp);
	}
	
	public static StringValueOfChar build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringValueOfChar(cfg, location, params[0]);
	}
