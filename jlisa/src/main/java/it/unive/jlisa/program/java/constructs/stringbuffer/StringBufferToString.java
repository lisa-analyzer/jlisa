...
public class StringBufferToString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public StringBufferToString(CFG cfg, CodeLocation location, Expression exp) {
		super(cfg, location, "toString", exp);
	}

	public static StringBufferToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringBufferToString(cfg, location, params[0]);
	}
