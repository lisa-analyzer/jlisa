...
import it.unive.jlisa.program.operator.JavaLongToStringUnaryInstanceOperator;
...
public class LongToStringUnaryInstance extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public LongToStringUnaryInstance(
			CFG cfg,
	...
	public static LongToStringUnaryInstance build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongToStringUnaryInstance(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdUnarySemantics(
		...
		it.unive.lisa.symbolic.value.UnaryExpression toString = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType,
				accessExpr,
				JavaLongToStringUnaryInstanceOperator.INSTANCE,
				getLocation());
