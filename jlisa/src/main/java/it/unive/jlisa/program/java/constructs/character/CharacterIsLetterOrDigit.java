...
public class CharacterIsLetterOrDigit extends it.unive.lisa.program.cfg.statement.UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public CharacterIsLetterOrDigit(CFG cfg, CodeLocation location, Expression arg) {
