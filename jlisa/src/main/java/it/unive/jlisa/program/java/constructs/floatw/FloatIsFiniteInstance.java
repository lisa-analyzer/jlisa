...
import it.unive.jlisa.program.operator.JavaFloatIsFiniteOperator;
...
public class FloatIsFiniteInstance extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public FloatIsFiniteInstance(
			CFG cfg,
	...
	public static FloatIsFiniteInstance build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new FloatIsFiniteInstance(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression un = new it.unive.lisa.symbolic.value.UnaryExpression(
				...
				access,
				JavaFloatIsFiniteOperator.INSTANCE,
				getLocation());
