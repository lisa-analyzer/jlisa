...
public class StringBuilderLength extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public StringBuilderLength(
			CFG cfg,
	...
	public static StringBuilderLength build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new StringBuilderLength(cfg, location, params[0]);
	}
