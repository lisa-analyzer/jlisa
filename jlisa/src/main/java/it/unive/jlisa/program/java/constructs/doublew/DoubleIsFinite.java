...
public class DoubleIsFinite extends UnaryExpression implements PluggableStatement {
	...
	public static DoubleIsFinite build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new DoubleIsFinite(cfg, location, params[0]);
	}
