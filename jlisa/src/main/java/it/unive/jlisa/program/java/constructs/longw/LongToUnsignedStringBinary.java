...
import it.unive.jlisa.program.operator.JavaLongToUnsignedStringBinaryOperator;
...
public class LongToUnsignedStringBinary extends BinaryExpression implements PluggableStatement {
	protected Statement originating;

	public LongToUnsignedStringBinary(
			CFG cfg,
			CodeLocation location,
			Expression left,
			Expression right) {
		super(cfg, location, "toString", left, right);
	}

	public static LongToUnsignedStringBinary build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new LongToUnsignedStringBinary(cfg, location, params[0], params[1]);
	}
	...
	public <A extends AbstractLattice<A>, D extends AbstractDomain<A>> AnalysisState<A> fwdBinarySemantics(
		...
		it.unive.lisa.symbolic.value.BinaryExpression toString = new it.unive.lisa.symbolic.value.BinaryExpression(
				...
				accessLeft,
				accessRight,
				JavaLongToUnsignedStringBinaryOperator.INSTANCE,
				getLocation());
