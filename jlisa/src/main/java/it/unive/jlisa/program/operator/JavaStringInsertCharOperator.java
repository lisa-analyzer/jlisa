...
public class JavaStringInsertCharOperator implements TernaryOperator {
	 ...
	 */
	public static final JavaStringInsertCharOperator INSTANCE = new JavaStringInsertCharOperator();
	 ...
	 */
	protected JavaStringInsertCharOperator() {
	}

	@Override
	public String toString() {
		return "string-insertchar";
	}
