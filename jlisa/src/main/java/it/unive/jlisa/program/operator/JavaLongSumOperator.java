...
public class JavaLongSumOperator implements BinaryOperator {

	/**
	 * The singleton instance of this class.
	 */
	public static final JavaLongSumOperator INSTANCE = new JavaLongSumOperator();
