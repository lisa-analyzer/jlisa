...
public class DoubleIsNaNInstance extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public DoubleIsNaNInstance(
			CFG cfg,
	...
	public static DoubleIsNaNInstance build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new DoubleIsNaNInstance(cfg, location, params[0]);
	}
