...
import it.unive.jlisa.program.operator.JavaByteStaticToStringOperator;
...
public class ByteStaticToString extends UnaryExpression implements PluggableStatement {
	protected Statement originating;

	public ByteStaticToString(
			CFG cfg,
	...
	public static ByteStaticToString build(
			CFG cfg,
			CodeLocation location,
			Expression... params) {
		return new ByteStaticToString(cfg, location, params[0]);
	}
	...
	public <A extends AbstractLattice<A>,
		...
		it.unive.lisa.symbolic.value.UnaryExpression un = new it.unive.lisa.symbolic.value.UnaryExpression(
				stringType,
				expr,
				JavaByteStaticToStringOperator.INSTANCE,
				getLocation());
