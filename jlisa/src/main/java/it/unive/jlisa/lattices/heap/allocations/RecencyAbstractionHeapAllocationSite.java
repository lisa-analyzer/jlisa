...
public class RecencyAbstractionHeapAllocationSite extends AllocationSite {
	...
	public RecencyAbstractionHeapAllocationSite lubWeak() throws SemanticException {
		...
		recent = new HeapAllocationSite(summary.getStaticType(), summary.getLocationName(), false,
				summary.getCodeLocation());
	...
	public AllocationSite toWeak() {
		return isWeak() ? this
				: new RecencyAbstractionHeapAllocationSite(getStaticType(), getLocationName(), getField(), true,
						getCodeLocation());
	}
	...
	public AllocationSite withField(
		...
		return new RecencyAbstractionHeapAllocationSite(getStaticType(), getLocationName(), field, isWeak(),
				getCodeLocation());
	...
	public AllocationSite withoutField() {
		if (getField() == null)
			return this;
		return new RecencyAbstractionHeapAllocationSite(getStaticType(), getLocationName(), isWeak(),
				getCodeLocation());
	...
	public AllocationSite withType(
			Type type) {
		return new RecencyAbstractionHeapAllocationSite(type, getLocationName(), getField(), isWeak(),
				getCodeLocation());
	}
	...
	@Override
	public RecencyAbstractionHeapAllocationSite lub(
			Identifier other)
