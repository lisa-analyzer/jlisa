 ...
 */
public class RecencyAbstractionHeapEnvWithFields
		extends
		FunctionalLattice<RecencyAbstractionHeapEnvWithFields, Identifier, AllocationSites>
		implements
		HeapLattice<RecencyAbstractionHeapEnvWithFields> {
	 ...
	 */
	public RecencyAbstractionHeapEnvWithFields() {
	...
	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> pushScope(
			ScopeToken scope,
			ProgramPoint pp)
			throws SemanticException {
		AtomicReference<SemanticException> holder = new AtomicReference<>();

		Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> result = liftIdentifiers(id -> {
			try {
	...
	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> popScope(
			ScopeToken scope,
			ProgramPoint pp)
			throws SemanticException {
		AtomicReference<SemanticException> holder = new AtomicReference<>();
	...
	private Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> liftIdentifiers(
		...
		if (r.isEmpty() && removed.getSources().isEmpty())
			return Pair.of(new RecencyAbstractionHeapEnvWithFields(lattice, function, fields), Collections.emptyList());

		r.addAll(expand(removed));
		return Pair.of(new RecencyAbstractionHeapEnvWithFields(lattice, function, fields), r);
	}

	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> forgetIdentifier(
			Identifier id,
			ProgramPoint pp)
			throws SemanticException {
		...
		return Pair.of(new RecencyAbstractionHeapEnvWithFields(lattice, result, f), expand(r));
	}

	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> forgetIdentifiers(
	...
	@Override
	public Pair<RecencyAbstractionHeapEnvWithFields, List<HeapReplacement>> forgetIdentifiersIf(
		...
		if (keys.isEmpty())
			return Pair.of(new RecencyAbstractionHeapEnvWithFields(lattice, function, f), Collections.emptyList());
	...
	@Override
	public RecencyAbstractionHeapEnvWithFields lubAux(
	...
	@Override
	public RecencyAbstractionHeapEnvWithFields upchainAux(
			RecencyAbstractionHeapEnvWithFields other)
			throws SemanticException {
		RecencyAbstractionHeapEnvWithFields chain = super.upchainAux(other);
		return new RecencyAbstractionHeapEnvWithFields(chain.lattice, chain.function, fields.upchain(other.fields));
	}

	@Override
	public RecencyAbstractionHeapEnvWithFields glbAux(
			RecencyAbstractionHeapEnvWithFields other)
			throws SemanticException {
		RecencyAbstractionHeapEnvWithFields glb = super.glbAux(other);
		return new RecencyAbstractionHeapEnvWithFields(glb.lattice, glb.function, fields.glb(other.fields));
	}

	@Override
	public RecencyAbstractionHeapEnvWithFields downchainAux(
			RecencyAbstractionHeapEnvWithFields other)
			throws SemanticException {
		RecencyAbstractionHeapEnvWithFields chain = super.downchainAux(other);
		return new RecencyAbstractionHeapEnvWithFields(chain.lattice, chain.function, fields.downchain(other.fields));
	}
	...
	@Override
	public RecencyAbstractionHeapEnvWithFields top() {
		return isTop() ? this : new RecencyAbstractionHeapEnvWithFields(lattice.top(), null, fields.top());
	}
	...
	@Override
	public RecencyAbstractionHeapEnvWithFields bottom() {
		return isBottom() ? this : new RecencyAbstractionHeapEnvWithFields(lattice.bottom(), null, fields.bottom());
	}
	...
	@Override
	public RecencyAbstractionHeapEnvWithFields mk(
			AllocationSites lattice,
			Map<Identifier, AllocationSites> function) {
		return new RecencyAbstractionHeapEnvWithFields(lattice, function, fields);
	}
	...
	public boolean equals(
		...
		if (getClass() != obj.getClass())
			return false;
		RecencyAbstractionHeapEnvWithFields other = (RecencyAbstractionHeapEnvWithFields) obj;
		if (fields == null) {
